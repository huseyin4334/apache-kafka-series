...
@Slf4j
public class OpenSearchConsumerWithAutoCommit {
    public static void main(String[] args) throws IOException {
        ...
        KafkaConsumer<String, String> consumer = clients.createKafkaConsumer();
        ...
        try (openSearchClient; consumer) {
            ...
            while (true) {
                ...
                recordSaver.save(records, openSearchClient, true);
            }
        }
